...
public class TicTacToeRules {
	...
	public static void main(String[] args) {
		System.out.format("%-1s %4s %4s %4s %4s","Tic Tac Toe Rules","","","","\n");
		System.out.format("%-1s %3s %4s %4s %4s","Tic Tac Toe is a game for 2 players.","","","","\n");
		System.out.format("%-1s %3s %4s %4s %4s","1.","A grid of 9 squares is drawn.","","","\n");
		System.out.format("%-1s %4s %4s %3s %4s","2.","The first player draws an X in an empty square.","","","\n");
